...
function HomePage() {
  return (
    <div>
      ...
      <div>
        <p className="mb-5 text-4xl font-thick text-center underline-offset-8 bg-slate-500 p-5"> Hello </p>
      </div>
      ...
      <p className="truncate">So many words gibberish words random stuff random words so that it will truncate</p>
      <p className="py-6 bg-blue-600 text-center text-xl"> Hello </p><p> Margin Testing </p>
