    ...
    return (
        <div className="drawer w-[200px]">
            ...
            <div className="drawer-content">
                <label htmlFor="my-drawer" className="btn drawer-button ">Order Details</label>
            </div>
                            ...
                            <table className="table-auto w-full mr-[20px] ">
                                <tbody>
                                    <tr className="mb-4 text-lg border-b-[0.5px] border-[#303031] " style={{ height: "50px" }}>
                                        ...
                                        <td className="w-1/2">{new Date(orderDetails.date).toLocaleDateString()}</td>
                                    </tr>
                                    <tr className="mb-4 text-lg border-b-[0.5px] border-[#303031]" style={{ height: "50px" }}>
                                    ...
                                    <tr className="mb-4 text-lg border-b-[0.5px] border-[#303031]" style={{ height: "50px" }}>
                                        ...
                                        <td className="w-1/2">{orderDetails.remarks ? orderDetails.remarks : 'N/A'}</td>
                                    </tr>
